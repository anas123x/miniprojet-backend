...
public class MaintenanceServices implements IMaintenanceService {
    ...
    public void performDailyMaintenance() {
        List<Bloc> blocs = blocRepository.findByEtat(Etat.mauvaise); // Utilisez la bonne énumération pour 'mauvaise'
        ...
        for (Bloc bloc : blocs) {
            ...
            bloc.setEtat(Etat.exelente); // Utilisez la bonne énumération pour 'excellente'
